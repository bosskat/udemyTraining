...
multiplexing the input channels onto a single channel that't closed when all
the inputs are closed.

PATTERN
There's a pattern to our pipeline functions:
-- stages close their outbound channels when all the send operations are done.
-- stages keep receiving values form inbound channels until those channels are closed.
